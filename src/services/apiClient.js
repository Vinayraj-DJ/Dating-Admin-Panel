...
// // Attach auth; ensure FormData gets proper multipart boundary
// apiClient.interceptors.request.use((config) => {
//   const token = localStorage.getItem("token");
//   if (token) config.headers.Authorization = `Bearer ${token}`;

//   // If sending FormData, remove any preset content-type so the browser sets it
//   const isFormData =
