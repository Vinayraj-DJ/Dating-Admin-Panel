...
// // Some backends only accept "Publish" | "Unpublish" (lowercase p);
// // normalize anything we get from the UI.
...
// // POST: /admin/languages  (name, status, image[file])
...
// ) {
//   const fd = new FormData();
//   if (typeof name !== "undefined") fd.set("name", name);
